...
public class WireExtension {
  ...
  public void sourcePath(Object... sourcePaths) {
    for (Object sourcePath : sourcePaths) {
      if (!(sourcePath instanceof String) && !(sourcePath instanceof FileCollection)) {
        throw new IllegalArgumentException(
            "sourcePath must consist of only file collection or external dependencies");
      }
  ...
  public void protoPath(Object... protoPaths) {
    for (Object protoPath : protoPaths) {
      if (!(protoPath instanceof String) && !(protoPath instanceof FileCollection)) {
        throw new IllegalArgumentException(
            "protoPath must consist of only file collection or external dependencies");
      }
